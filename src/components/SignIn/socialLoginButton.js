...
const kakaoLoginUrl = `https://kauth.kakao.com/oauth/authorize?client_id=${process.env.REACT_APP_KAKAO_API_KEY}&redirect_uri=${process.env.REACT_APP_KAKAO_REDIRECT_URL}&response_type=code`;
...
export default function SocialLoginButton() {
    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'space-evenly' }}>
            ...
            <Button
                sx={{ ...socialLoginButtonStyle, backgroundColor: '#ffffff' }}
                variant="contained">
